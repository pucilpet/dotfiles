...
-- tries to find a matching file name in /nix/store/ppyd63qj3ybiv94smq48dfm8g21jgbbh-system-path/share/icons/THEME/RESOLUTION/apps/ and if not found tried with first letter
...
function Get_icon(theme, client, program_string, class_string, is_steam)
	...
	if theme and (client or program_string or class_string) then
		...
		elseif client then
			...
			elseif client.name then
				...
				if client.icon then
					...
					return "/nix/store/ppyd63qj3ybiv94smq48dfm8g21jgbbh-system-path/share/icons/Papirus-Dark/128x128/apps/application-default-icon.svg"
				end
			end
		else
		...
		for _, res in ipairs(resolutions) do
			local iconDir = "/nix/store/ppyd63qj3ybiv94smq48dfm8g21jgbbh-system-path/share/icons/"
				.. theme
				.. "/"
				.. res
				.. "/apps/"
			...
			if ioStream ~= nil then
				...
				iconDir = "/nix/store/ppyd63qj3ybiv94smq48dfm8g21jgbbh-system-path/share/icons/"
					.. theme
					.. "/"
					.. res
					.. "/apps/"
